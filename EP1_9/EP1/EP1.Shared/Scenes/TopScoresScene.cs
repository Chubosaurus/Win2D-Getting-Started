...
{
    /// <summary>
    /// A sample Top Score Scene.
    /// </summary>
    public class TopScoresScene : GenericScene
    {
        public TopScoresScene(int width, int height)
            : base("Top Score Scene")
        {
            this._width = width;
            this._height = height;
            this.SetupScene();
        ...
        protected override void SetupScene()
        {
            ...
            _title_label = new CGL_Label("Generic Top Score Scene", Colors.White, (uint)(this._width * 0.60f), 100);
            _title_label.Y = 20;
