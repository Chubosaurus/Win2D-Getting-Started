...
{
    /// <summary>
    /// A Generic Game Play Scene.
    /// </summary>
    public class MainGamePlayScene : GenericScene
    {
        public MainGamePlayScene(int width, int height)
            : base("Main Game Scene")
        {
            this._width = width;
            this._height = height;
            this.SetupScene();
        ...
        protected override void SetupScene()
        {
            ...
            _title_label = new CGL_Label("Generic Main Game Scene", Colors.White, (uint)(this._width * 0.60f), 100);
            _title_label.Y = 20;
